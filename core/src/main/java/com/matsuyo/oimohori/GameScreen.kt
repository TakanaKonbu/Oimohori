...
class GameScreen(private val game: GameMain) : ScreenAdapter() {
    ...
    private val imoTypes = listOf(
        ...
        ImoType("シマウマ芋", "zebra_imo.png", 15, 70, 0.2f),
        ImoType("ウシ芋", "cow_imo.png", 15, 70, 0.2f),
        ImoType("DJ芋", "dj_imo.png", 17, 80, 0.2f),
        ImoType("虹芋", "rainbow_imo.png", 17, 80, 0.2f),
        ImoType("迷彩芋", "meisai_imo.png", 17, 80, 0.2f),
